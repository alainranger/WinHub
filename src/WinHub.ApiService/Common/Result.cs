...
public class Result
{
	...
	public static Result<TValue> Success<TValue>(TValue value) => new(value, true, ApiError.None);
	...
	/// </remarks>
	public static Result<TValue> Failure<TValue>(ApiError error) => new(default!, false, error);
