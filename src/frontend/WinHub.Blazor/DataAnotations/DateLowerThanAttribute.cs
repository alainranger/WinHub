...
internal sealed class DateLowerThanAttribute : ValidationAttribute
{
	public string ComparisonProperty { get; }

	public DateLowerThanAttribute(string comparisonProperty)
	{
	...
	protected override ValidationResult IsValid(object? value, ValidationContext validationContext)
	{
		...
		{
			return new ValidationResult(ErrorMessage ?? $"The date must be lower than {ComparisonProperty}.");
		}
